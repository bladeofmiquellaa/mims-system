...
<title>افزودن پرونده</title>
    <div class="case container">
        ...
        <form action="addingcase" method="post" enctype="multipart/form-data">
            <div class="case-main">
                <div class="case-input">
                    ...
                    <div>
                        ...
                        <input type="text" name="history" autocomplete="off" value="{{old('history')}}">
                    </div>
                    <div>
                        <label >کتگوری</label>
                    ...
                    <div>
                        ...
                        <select class="sub-category" style="opacity: 50%;pointer-events: none" name="subcategory">
                    ...
                    <div>
                        ...
                        <select name="state" >
                            <option></option>
                            <option value="approved">انتشار</option>
