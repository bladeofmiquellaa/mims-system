...
<section class="dashboard">
    ...
    <div class="container DoctorCasesTable" style="margin: 70px 0px 35px 0px;">
            ...
            <div class="filter">
                ...
                <div class="select-box">
                    <div class="category-box">
                        <ul style="padding: 0%; margin: 0; margin-left: 7px">
                            <li class="menu" id="sub-cat" style="display: none;">
           ...
           @else
               <tr>
                   ...
                   @if($case['state']=='approved')
                       <td>تایید شده</td>
                   @endif
                   @if($case['state']=='dr_draft')
                       <td>پیشفرض</td>
                   @endif
                   <td>{{$case['created_at']}}</td>
                   <td>{{$case['updated_at']}}</td>
                   <td> <a href="http://127.0.0.1:8000/user/doctor/viewcase/{{$case['id']}}"> نمایش</a></td>
               </tr>
           @endif
